...
def start_message(play):
    bot.send_message(play.chat.id, 'Првиет, давай поиграем в игру "Отгадай значение"', reply_markup=keyboard2)

@bot.message_handler(commands=['go'])
def start_message(go):
